...
const CtaSection = () => {
  ...
  return (
    <section id='contact' className='my-[75px] xl:my-[150px] border-t-2' data-aos='fade-up'>
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row justify-between items-center'>
          ...
          <div className='flex flex-col xl:flex-row gap-y-4 gap-x-[30px]'>
            ...
            <button
              className='cursor-wait btn btn-quaternary flex items-center gap-x-[20px] group animate-pulse'
              data-aos='fade-up'
              data-aos-delay='400'
            >
              {btnText2}
