...
const Features = () => {
  ...
  return (
    <section className='my-[70px] xl:my-[150px]' id='features'>
              ...
              >
                ...
                <div className='max-w-[220px]'>
                  ...
                  <div className='flex items-center gap-x-2 group'>
                    ...
                    <IoCheckmarkDoneSharp className='text-4xl text-accent-primary group-hover:scale-150 animate-pulse duration-700 transition-all' />
                  </div>
                </div>
              </div>
            );
